...
| --------- | --------------------------------------- | -------------------------------------------------- | ----------------------------------- |
| Yu Qiao | [2908983Q@student.gla.ac.uk](2908983Q@student.gla.ac.uk)        | Responsible for the overall project software framework design, front-end overall development, hardware development | [qiaoyu113](https://github.com/qiaoyu113)    |
